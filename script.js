...
let originalQuestions = [
    { q: "Which disease is also called breakbone fever because of the extreme pain it causes in the joints?", options: ["Dengue", "Polio", "Influenza", "Typhoid"], answer: "Dengue" }, 
    { q: "Also known as varicella, which viral infection causes itchy blisters all over the body?", options: ["Measles", "Mumps", "Smallpox", "Chickenpox"], answer: "Chickenpox" }, 
    { q: "Which disease is also called lockjaw?", options: ["Tetanus", "Tuberculosis", "Plaque", "Hepatitis"], answer: "Tetanus" }, 
    { q: "Which disease is caused by the bite of the female anopheles mosquito?", options: ["Cholera", "Plague", "Malaria", "Dengue"], answer: "Malaria" }, 
    { q: "Which of these is a serious infection of the lungs in which the air sacs fill with fluid and pus leading to severe breathing problems?", options: ["Jaundice", "Pneumonia", "Typhoid", "Cholera"], answer: "Pneumonia" }, 
    { q: "Which viral infection of the respiratory passage is spread by breathing airborne droplets infected with one of the four viruses—A, B, C or D?", options: ["Polio", "Influenza", "Measles", "Typhoid"], answer: "Influenza" }, 
